/* ============================================================================
 * ds/js/zg-ga4.js — 젠제네틱스 GA4 계측 (전 페이지 공통)
 *
 * 원칙
 ...
 *
 * 로드 위치
 *  - 일반 페이지   : moa/layout/head.html 의 <!--@js(/ds/js/zg-ga4.js)--> 한 줄
...
(function () {
  ...
  var ZG_VER = '2.003';   /* 2.001 = 도입판 / 2.002 = 상세 개편판 / 2.003 = 홈 개편판(히어로·제품 3블록) */
